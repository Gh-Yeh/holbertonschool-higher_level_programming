...
class TestSquare_instantiation(unittest.TestCase):
    ...
    def test_class(self):
        ...
        self.assertEqual(
            str(Square), "<class 'models.square.Square'>")
    ...
    def test_size_private(self):
        '''Tests if size is private class attribute.'''
        with self.assertRaises(AttributeError):
            print(Square(10, 2, 3, 4).__size)

    def test_size_getter(self):
        '''Tests if the size getter method.'''
        self.assertEqual(5, Square(5, 2, 3, 9).size)

    def test_size_setter(self):
        '''Tests if the size setter method.'''
        s = Square(4, 1, 9, 2)
        s.size = 8
        self.assertEqual(8, s.size)

    def test_sqaure_instantiation(self):
        '''Tests instantiation.'''
...
class TestSquare_size(unittest.TestCase):
    ...
    def test_negative_size(self):
        '''Tests the size is psotive'''
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            Square(-1, 2)

    def test_zero_size(self):
        '''Tests the size greater than zero'''
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            Square(0, 2)
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def test_str_method_print_size(self):
        '''Tests the print.'''
        s = Square(4)
        capture = TestSquare_stdout.capt_out(s, "print")
        trystr = "[Square] ({}) 0/0 - 4\n".format(s.id)
    ...
    def test_str_method_size_x(self):
        ...
        s = Square(5, 5)
        trystr = "[Square] ({}) 5/0 - 5".format(s.id)
        self.assertEqual(trystr, s.__str__())

    def test_str_method_size_x_y(self):
        '''Tests the str function.'''
        s = Square(7, 4, 22)
        trystr = "[Square] ({}) 4/22 - 7".format(s.id)
        self.assertEqual(trystr, str(s))
    ...
    def test_display_size(self):
        ...
        s = Square(2, 0, 0, 9)
        capture = TestSquare_stdout.capt_out(s, "display")
        self.assertEqual("##\n##\n", capture.getvalue())
